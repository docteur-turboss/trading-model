import { Agent } from "../neural_network/agent";
import { createWallet, WalletConfig } from "../env/wallet-manager";
import StateManager, { StateManagerConfig } from "./state_manager";
...
export class TradingAgent {
  ...
  public mapOutputToAction(output: Float32Array, cfg?: TradingAgentConfig): { action: "buy" | "sell" | "hold"; amount: number } {
  ...
  public step(input: Float32Array, price?: number, done: boolean = false): { action: string; reward: number; metrics: any } {
