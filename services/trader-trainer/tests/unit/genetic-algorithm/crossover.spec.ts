...
import type { CrossoverType } from '../../../src/core/genetic-algorithm/genome-types';
...
describe('Crossover - crossoverGenomes', () => {
  ...
  test('should handle parents with different hidden layer counts', () => {
    ...
    parentB.network.hiddenLayers = [
      { neurons: 128, activation: 'ReLu', connectionType: 'dense-skip', biasType: 'zeros' },
    ];
