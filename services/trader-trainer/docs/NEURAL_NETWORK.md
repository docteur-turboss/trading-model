...
The neural network module (`src/core/neural-network/`) implements a configurable **feedforward fully-connected network** with support for:

- Multiple activation functions, loss functions, optimizers
- Normalization strategies
- Experience replay pool (experience replay for DQN)
- Supervised and Q-learning training modes
- Weight serialization for GA integration
