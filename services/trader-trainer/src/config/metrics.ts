...
export const evaluationDurationSeconds = new promClient.Histogram({
  name: 'trainer_evaluation_duration_seconds',
  help: 'Single genome evaluation latency in seconds',
  buckets: [0.1, 0.5, 1, 2, 5, 10, 30, 60],
});

export const marketDataProcessed = new promClient.Counter({
