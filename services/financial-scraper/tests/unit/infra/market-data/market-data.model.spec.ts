...
jest.mock('../../../../src/infra/market-data/schema/orderBook.schema', () => ({
...
describe('MarketDataModel', () => {
  ...
  it('insertCandles should delegate to schema', async () => {
    ...
    const { insertCandles } = require('../../../../src/infra/market-data/schema/candles-schema')
  ...
  it('insertTrades should delegate to schema', async () => {
    ...
    const { insertTrades } = require('../../../../src/infra/market-data/schema/trades.schema')
  ...
  it('insertOrderBook should delegate to schema', async () => {
    ...
    const { insertOrderBook } = require('../../../../src/infra/market-data/schema/orderBook.schema')
  ...
  it('insertTicker should delegate to schema', async () => {
    ...
    const { insertTicker } = require('../../../../src/infra/market-data/schema/ticker24h.schema')
