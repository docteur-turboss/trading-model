...
let mockRequestUseHandler: any;
let mockResponseFulfilledHandler: any;
let mockResponseRejectedHandler: any;
  ...
  mockInstance.interceptors = {
    request: {
      use: jest.fn((fulfilled: any) => {
        mockRequestUseHandler = fulfilled;
      }),
    },
    response: {
      use: jest.fn((fulfilled: any, rejected: any) => {
        mockResponseFulfilledHandler = fulfilled;
        mockResponseRejectedHandler = rejected;
      }),
    },
  };
...
describe('createHttpClient', () => {
  beforeEach(() => {
    mockRequestUseHandler = undefined;
    mockResponseFulfilledHandler = undefined;
    mockResponseRejectedHandler = undefined;
  });
