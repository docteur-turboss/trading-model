...
const MESSAGE_MANAGER_ENV_DEFS = [
	...
	[
		"STALE_HEARTBEAT_INTERVAL_MS",
		z.coerce.number().int().positive().default(10_000),
	],
	[
		"STALE_MISSED_HEARTBEAT_THRESHOLD",
