export type PlatformFlagName = string & { readonly brand: "PlatformFlagName" };

export const PlatformFlagName = {
	DLQ_AUTO_RETRY: "DLQ_AUTO_RETRY" as PlatformFlagName,
	CANARY_MIGRATIONS: "CANARY_MIGRATIONS" as PlatformFlagName,
	STRICT_CIRCUIT_BREAKER: "STRICT_CIRCUIT_BREAKER" as PlatformFlagName,
	MESSAGE_DEDUPLICATION: "MESSAGE_DEDUPLICATION" as PlatformFlagName,
	GRACEFUL_SHUTDOWN_DRAIN: "GRACEFUL_SHUTDOWN_DRAIN" as PlatformFlagName,
	ENABLE_REQUEST_LOGGING: "ENABLE_REQUEST_LOGGING" as PlatformFlagName,
	ENABLE_METRICS_EXPORT: "ENABLE_METRICS_EXPORT" as PlatformFlagName,
	ENABLE_DETAILED_ERROR_RESPONSE:
		"ENABLE_DETAILED_ERROR_RESPONSE" as PlatformFlagName,
	ENABLE_CACHE_BYPASS: "ENABLE_CACHE_BYPASS" as PlatformFlagName,
	WAL_SYNCHRONOUS_FLUSH: "WAL_SYNCHRONOUS_FLUSH" as PlatformFlagName,
	ENABLE_TELEMETRY_DETAILED: "ENABLE_TELEMETRY_DETAILED" as PlatformFlagName,
	ENFORCE_MTLS_STRICT: "ENFORCE_MTLS_STRICT" as PlatformFlagName,
} as const;
