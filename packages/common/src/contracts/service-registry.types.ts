...
export interface RegistryBackend {
  ...
  updateHeartbeat(serviceName: string, instanceId: string): Promise<number | false>;
  ...
  getInstance(serviceName: string, instanceId: string): Promise<ServiceInstance | undefined>;
