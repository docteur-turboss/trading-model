import { EnumEventMessage, EventMap, MarketType, SourceType } from "@trading-model/common/config/event.types";
...
export const PublisherMetadataContextPredicate = z.object({
  serviceName: z.enum(Object.keys(ServiceInstanceName) as [string, ...string[]], `publisher.serviceName value is invalid. Expected one of: ${Object.keys(ServiceInstanceName).join(", ")}.`),
