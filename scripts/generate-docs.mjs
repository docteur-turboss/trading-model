...
const MODULES = [
  ...
  },
  {
    ...
    entryPoints: [join(ROOT, 'services/discovery-server/src/app/index.ts')],
    strategy: 'resolve',
    tsconfig: join(ROOT, 'services/discovery-server/tsconfig.json'),
  },
  {
    label: 'message-manager',
    entryPoints: [join(ROOT, 'services/message-manager/src/app/index.ts')],
    strategy: 'resolve',
    tsconfig: join(ROOT, 'services/message-manager/tsconfig.json'),
  },
  {
    label: 'financial-scraper',
    entryPoints: [join(ROOT, 'services/financial-scraper/src/app/index.ts')],
    strategy: 'resolve',
    tsconfig: join(ROOT, 'services/financial-scraper/tsconfig.json'),
  },
  {
    label: 'trader-trainer',
    entryPoints: [join(ROOT, 'services/trader-trainer/src/app/index.ts')],
    strategy: 'resolve',
