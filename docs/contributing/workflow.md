...
See [`docs/standards/commit-standards.md`](../standards/commit-standards.md) for the full list of types.
...
See [`docs/standards/pr-standards.md`](../standards/pr-standards.md) for the template and guidelines.
...
2. Set up the machine (see [SETUP.md](../deployment/SETUP.md))
