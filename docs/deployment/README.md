...
| [CI/CD Pipeline](../ci-cd/README.md)| GitHub Actions: lint, typecheck, test, 9-image Docker build & publish, GitHub Release     |
| [Environment Variables](ENV.md)        | Exhaustive table of all variables across all services: type, default, required, description |
| [Database](DATABASE.md)                | MySQL (financial-scraper), MongoDB (5 databases), volumes, migration, reset                |
...
| [Troubleshooting](../troubleshooting/README.md) | Common issues: Docker, MySQL, MongoDB, TLS, npm, networking, Git, testing          |
